...
protocol APISessionContract {
    func request<Request: APIRequest>(_ apiRequest: Request, completion: @escaping (Result<Data, Error>) -> Void)
}
...
struct APISession: APISessionContract {
    ...
    init(session: URLSession = URLSession(configuration: .default),
         requestInterceptors: [APIRequestInterceptor] = [AuthenticationRequestInterceptor()]) {
